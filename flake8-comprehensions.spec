...
Version  : 3.1.1
Release  : 11
URL      : https://files.pythonhosted.org/packages/71/bb/13a7d4ca9fdc2a806965ec145bca27e05977bf3b5823f00cf5e61d11eb59/flake8-comprehensions-3.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/71/bb/13a7d4ca9fdc2a806965ec145bca27e05977bf3b5823f00cf5e61d11eb59/flake8-comprehensions-3.1.1.tar.gz
Source1 : https://files.pythonhosted.org/packages/71/bb/13a7d4ca9fdc2a806965ec145bca27e05977bf3b5823f00cf5e61d11eb59/flake8-comprehensions-3.1.1.tar.gz.asc
...
%prep
%setup -q -n flake8-comprehensions-3.1.1
cd %{_builddir}/flake8-comprehensions-3.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574005787
...
cp %{_builddir}/flake8-comprehensions-3.1.1/LICENSE %{buildroot}/usr/share/package-licenses/flake8-comprehensions/3b98f67b904745157b7acca53f96f7aa7bd2d01c
